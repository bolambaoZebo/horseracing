...
class ChannelTwo : Fragment(), RecyclerAdapter.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_channel_two, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        home_recycler.adapter = activity?.let {
            RecyclerAdapter(it, getAllRacing(),0,this)//RecyclerAdapter(it, getAllRacing(), 0 , this)
        }
    }

    private fun getAllRacing(): ArrayList<HorseModel> {
        val imgs = getResources().obtainTypedArray(R.array.array_horse_racing2)
        val title = resources.getStringArray(R.array.array_title2)
        val dateR = resources.getStringArray(R.array.array_date2)
        val timeR = resources.getStringArray(R.array.array_time2)
        val id = resources.getStringArray(R.array.array_channel2)
